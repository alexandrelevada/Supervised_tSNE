...
# -*- coding: utf-8 -*-
"""
Regular SNE and t-SNE Python implementation
...
def q_joint(Y, y):
    ...
    distances = neg_squared_euc_dists(Y, y)
...
def p_joint(X, y, target_perplexity):
    ...
    distances = neg_squared_euc_dists(X, y)
...
if __name__ == '__main__':
    ...
    dados_lda = model.fit_transform(X, rotulos)

    L_lda = Classification(dados_lda, rotulos)